...
import { InitiateTransferAnotherBank } from "../../../../Redux/UserAuth/Auth";
...
const AnotherBank = () => {
  ...
  const handleTransactions = (e) => {
    ...
    dispatch(InitiateTransferAnotherBank(formValues));
  };
  return (
    <>
      {isSmallScreen ? (
        <Box sx={{ width: "100%", paddingX: 2, paddingTop: 2 }}>
          <Stack direction={"row"} alignItems={"center"} spacing={3}>
            ...
            <Typography variant="h5">To another BPI account</Typography>
          </Stack>
              ...
              >
                ...
                <Box sx={{ maxWidth: 500, marginTop: 2 }}>
                  ...
                  <TextField
                    fullWidth
                    variant="outlined" // or "filled", "standard"
                    placeholder="Swift Code(Ifsc Code)"
                    autoComplete="off"
                    name="swiftCode"
                  ...
                  <TextField
                    fullWidth
                    variant="outlined" // or "filled", "standard"
                    placeholder="Descriptions (What for)"
                    autoComplete="off"
                    name="description"
